...
import net.teamfruit.autoinput.bnnwidget.OverridablePoint;
import net.teamfruit.autoinput.bnnwidget.ShortestFloatFormatter;
import net.teamfruit.autoinput.bnnwidget.WEvent;
import net.teamfruit.autoinput.bnnwidget.WPanel;
import net.teamfruit.autoinput.bnnwidget.component.MChatTextField.CharacterFilter;
