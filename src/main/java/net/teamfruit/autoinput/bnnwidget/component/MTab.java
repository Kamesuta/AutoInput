...
import net.teamfruit.autoinput.bnnwidget.WBox;
import net.teamfruit.autoinput.bnnwidget.WCommon;
import net.teamfruit.autoinput.bnnwidget.WEvent;
import net.teamfruit.autoinput.bnnwidget.WPanel;
import net.teamfruit.autoinput.bnnwidget.WidgetBuilder;
...
import net.teamfruit.autoinput.bnnwidget.position.Coord.CoordSide;
import net.teamfruit.autoinput.bnnwidget.var.VCommon;
